...
<head>
  ...
  <body style="display: flex; min-height: 100vh; flex-direction: column;">
        ...
        <ul class="sidenav white" id="mobile-demo">
            ...
            <li class="active"><a href="<?= base_url();?>Pendaftar_C/lowonganKerja"><i class="material-icons left">work</i>Lowongan Pekerjaan</a></li>
          ...
          <div class="container">
            <div class="row">
              <div class="col l12 s12">
                <h2 style="font-weight: bold; font-family: Roboto; color: green;" >Lowongan Kerja Tersedia</h2>
              </div>
            </div>
          </div>
